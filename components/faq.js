                ...
                <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center mb-16">
                        <h2 class="text-3xl md:text-4xl font-display font-bold">
                            Frequently Asked <span class="bg-clip-text text-transparent bg-gradient-to-r from-primary-400 to-primary-600">Questions</span>
                        </h2>
                        <p class="mt-4 max-w-2xl mx-auto text-lg text-gray-400">
                            Everything you need to know about ScaleBuddy
                        </p>
                    </div>
                    
                    <div class="space-y-4">
                        <div class="faq-item bg-dark-900 rounded-2xl border border-gray-800 hover:border-primary-500/30 transition-all duration-300">
                            <button class="faq-question w-full text-left px-8 py-6 flex items-center justify-between group" aria-expanded="false">
                                <span class="text-xl font-display font-semibold text-gray-100 pr-4">How long does setup take?</span>
                                <i data-feather="chevron-down" class="w-6 h-6 text-primary-400 transform transition-transform duration-300 flex-shrink-0 group-aria-expanded:rotate-180"></i>
                            </button>
                        ...
                        <div class="faq-item bg-dark-900 rounded-2xl border border-gray-800 hover:border-primary-500/30 transition-all duration-300">
                            <button class="faq-question w-full text-left px-8 py-6 flex items-center justify-between group" aria-expanded="false">
                                <span class="text-xl font-display font-semibold text-gray-100 pr-4">Is my data secure? Do you comply with GDPR?</span>
                                <i data-feather="chevron-down" class="w-6 h-6 text-primary-400 transform transition-transform duration-300 flex-shrink-0 group-aria-expanded:rotate-180"></i>
                            </button>
                            <div class="faq-answer hidden px-8 pb-6">
                                <p class="text-gray-400 font-sans leading-relaxed">
                        ...
                        <div class="faq-item bg-dark-900 rounded-2xl border border-gray-800 hover:border-primary-500/30 transition-all duration-300">
                            <button class="faq-question w-full text-left px-8 py-6 flex items-center justify-between group" aria-expanded="false">
                                <span class="text-xl font-display font-semibold text-gray-100 pr-4">Which CRM systems do you integrate with?</span>
                                <i data-feather="chevron-down" class="w-6 h-6 text-primary-400 transform transition-transform duration-300 flex-shrink-0 group-aria-expanded:rotate-180"></i>
                            </button>
                            <div class="faq-answer hidden px-8 pb-6">
                                <p class="text-gray-400 font-sans leading-relaxed">
                        ...
                        <div class="faq-item bg-dark-900 rounded-2xl border border-gray-800 hover:border-primary-500/30 transition-all duration-300">
                            <button class="faq-question w-full text-left px-8 py-6 flex items-center justify-between group" aria-expanded="false">
                                <span class="text-xl font-display font-semibold text-gray-100 pr-4">Do I need to know how to code?</span>
                                <i data-feather="chevron-down" class="w-6 h-6 text-primary-400 transform transition-transform duration-300 flex-shrink-0 group-aria-expanded:rotate-180"></i>
                            </button>
                            <div class="faq-answer hidden px-8 pb-6">
                                <p class="text-gray-400 font-sans leading-relaxed">
                                    No coding required! ScaleBuddy is built for business owners, not developers. We handle all the technical setup, configuration, and maintenance. You simply provide your business requirements, and we build everything for you. Once live, everything runs automatically.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-dark-900 rounded-2xl border border-gray-800 hover:border-primary-500/30 transition-all duration-300">
                            <button class="faq-question w-full text-left px-8 py-6 flex items-center justify-between group" aria-expanded="false">
                                <span class="text-xl font-display font-semibold text-gray-100 pr-4">How does the voice agent sound? Will customers know it's AI?</span>
                                <i data-feather="chevron-down" class="w-6 h-6 text-primary-400 transform transition-transform duration-300 flex-shrink-0 group-aria-expanded:rotate-180"></i>
                            </button>
                            <div class="faq-answer hidden px-8 pb-6">
                                <p class="text-gray-400 font-sans leading-relaxed">
